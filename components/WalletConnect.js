...
export default function WalletConnet() {
    return (
        <>
            <div className="flex lg:flex-row md:flex-col mt-5">
                <button type="kaikas" className="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
                ...
                <button className="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center lg:ml-4 md:ml-0 ml-4 md:mt-4 mt-0 lg:mt-0 hover:bg-gray-200 focus:outline-none">
                    ...
                    <span className="ml-4 flex items-start flex-col leading-none">
                        <span className="text-xs text-gray-600 mb-1">Metamask1</span>
                        <span className="title-font font-medium">Disconnected</span>
                    </span>
                </button>
            </div>
        </>
